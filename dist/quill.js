...
var isRegex = __webpack_require__(75);
...
var Selection = function () {
  ...
  _createClass(Selection, [{
    ...
    value: function getNativeRange() {
      var selection = this.documentContext.getSelection();
    ...
    key: 'hasFocus',
    value: function hasFocus() {
      return this.documentContext.activeElement === this.root;
    }
  }, {
...
var bind = __webpack_require__(22);
var hasOwn = __webpack_require__(72);
...
var BaseTheme = function (_Theme) {
  ...
  function BaseTheme(quill, options) {
    ...
    quill.emitter.listenDOM('click', _this.documentContext, listener);
    return _this;
  }
...
var _composedPathPolyfill = __webpack_require__(64);

var _getRootNodePolyfill = __webpack_require__(65);
